...
This repository provides information on the compressibility of a human genome (T2T Chm13 v2.0) using <b>GeCo3</b> ([Article](https://doi.org/10.1093/gigascience/giaa119), [Code](https://github.com/cobilab/geco3)) with specific models for the setup to be used by the compressor.
