...
#
# Data compression:
time ./JARVIS2.sh --level "-lr 0.01 -hs 64 -rm 10000:15:0.1:0.9:7:0.1:1:0.95:0 -cm 1:1:0:0.7/0:0:0:0 -cm 3:1:0:0.85/0:0:0:0 -cm 7:1:0:0.8/0:0:0:0 -cm 12:10:1:0.95/0:0:0:0"  --block 1100MB --threads 1 --dna --input HS.seq; ls -la HS.seq.tar 1> report_c_stdout.txt 2> report_c_stderr.txt;
#
# Data decompression:
