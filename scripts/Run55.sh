...
#
# Data compression:
time ./JARVIS2.sh --level "-lr 0.01 -hs 42 -rm 200:11:1:0.9:7:0.3:1:0.2:220000 -cm 12:1:1:0.85/0:0:0:0"  --block 405MB --threads 8 --dna --input HS.seq 1> report_c_stdout.txt 2> report_c_stderr.txt;
ls -la HS.seq.tar 1>> report_c_stdout.txt 2>> report_c_stderr.txt;
#
# Data decompression:
time ./JARVIS2.sh  --decompress --threads 8 --dna --input HS.seq.tar 1> report_d_stdout.txt 2> report_d_stderr.txt;
#
# Lossless validation:
