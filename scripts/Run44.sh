...
#
# Data compression:
time ./JARVIS2.sh --level "-lr 0.01 -hs 24 -rm 5000:15:0.1:0.9:7:0.1:1:0.95:0 -cm 12:1:1:0.95/0:0:0:0" --block 1100MB --threads 1 --dna --input HS.seq 1> report_c_stdout.txt 2> report_c_stderr.txt;
#
# Data decompression:
